...
export const LINKS = [
    ...
    { label: "Github", handle: "My github page where the website is hosted", Icon: SiGithub, url: "https://github.com/Sofilaxus", bg: "rgba(80, 90, 200, 0.15)", border: "rgba(100, 111, 230, 0.28)" },
];
